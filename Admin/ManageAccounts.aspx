<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ManageAccounts.aspx.vb" Inherits="Admin_ManageAccounts" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>DCSA - Manage Accounts</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Navbar" Runat="Server">
    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
        ...
        <li class="nav-item me-0 me-lg-3">
            <a class="nav-link ms-3 ms-lg-0 active" aria-current="page" href="./ManageAccounts.aspx">Manage Accounts</a>
        </li>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header d-flex align-items-center">
                            <h6 class="modal-title" id="profileViewLabel">Manage Accounts</h6>
                        ...
                        <div class="modal-body">
                         ...
                         <div class="modal-footer">
                            <input type="button" class="btn btn-sm btn-outline-danger mt-1" value="Edit">
                        </div> 
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center align-items-center" style="height: 100vh;">
                    <div class="col">
                        <div class="row justify-content-center">
                            <h1 class="col-auto">Manage Accounts</h1>
                        </div>
