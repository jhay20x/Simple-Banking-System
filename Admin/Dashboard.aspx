<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Dashboard.aspx.vb" Inherits="Admin_Dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Navbar" Runat="Server">
    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
        ...
        <li class="nav-item me-0 me-lg-3">
            <a class="nav-link ms-3 ms-lg-0" aria-current="page" href="./ManageAccounts.aspx">Manage Accounts</a>
        </li>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-3 mb-sm-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-text"><asp:Label ID="TotalClients" runat="server">0</asp:Label></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-3 mb-sm-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-text"><asp:Label ID="TotalDeposit" runat="server">0</asp:Label></h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 col-lg-3 mb-3 mb-sm-0">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h3 class="card-text"><asp:Label ID="TotalWithdraw" runat="server">0</asp:Label></h3>
                            </div>
                        </div>
                    </div>
                </div>
