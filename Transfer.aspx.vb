...
Partial Class Transfer
    ...
    Protected Sub transferDCSABtn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles transferDCSABtn.Click
        ...
        If selectedOption = "None" Then
            Dim errorScript As String = "$(""#errorDCSAMessage"").append('<div class=""alert alert-danger"" role=""alert"">No funds selected.</div>');"
        ...
        '    Dim errorScript As String = "$(""#errorDCSAMessage"").append('<div class=""alert alert-danger"" role=""alert"">" & amount & "</div>');"
        '    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "ErrorFundsMesssage", errorScript, True)
        'End If
        ...
        TransactTransfer(selectedOption, accountNumber, amount)
    End Sub
    ...
    Private Function CheckAccountNumber(ByVal accountNumber As String) As Boolean
    ...
    Private Sub TransactTransfer(ByVal userAccountNumber As String, ByVal accountNumber As String, ByVal amount As String)
        Dim query1 = "UPDATE Accounts SET AvailableBalance = AvailableBalance - @Amount, TotalBalance = TotalBalance - @Amount WHERE AccountsID = @UserAccountID"
        ...
        Dim query2 = "UPDATE Accounts SET AvailableBalance = AvailableBalance + @Amount, TotalBalance = TotalBalance + @Amount WHERE AccountsID = @AccountsID"
