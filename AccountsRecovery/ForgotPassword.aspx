<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ForgotPassword.aspx.vb" Inherits="Accounts_ForgotPassword" %>
    ...
    <form id="myForm" class="col-10 col-sm-6 col-md-6 col-lg-5 col-xl-3" runat="server">
        <div class="p-5 flex-column bg-white rounded shadow d-flex align-items-center row">
            ...
            <div class="col text-center my-1">
                ...
                <h6><span class="fw-normal">Please enter your email and we will send an OTP Code in your email.</span></h6>
            </div>
